<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="RegistrationTrainer.aspx.cs" Inherits="RegistrationTrainer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="container">
    <h1 style="color:white;font-size:.7cm;background-color:#ff6a00;padding:2px;">Trainer Registration</h1>
        <hr />
        <div>
